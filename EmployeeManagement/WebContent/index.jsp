			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="loginServlet" method="post" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="username" autocomplete="off" pattern="[a-z0-9._%+-]{1,40}[@]{1}[a-z]{1,10}[.]{1}[a-z]{3}"
												   oninvalid="this.setCustomValidity('Incorrect')"  
												   onchange="try{setCustomValidity('')}catch(e){}"
					     						   oninput="setCustomValidity(' ')"  placeholder="username" checked required>
